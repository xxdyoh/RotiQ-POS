...
class VoidItemsService {
  ...
  static Future<Map<String, dynamic>> getVoidItems({
    ...
    try {
      ...
      final url = '$baseUrl/report/void-items?start_date=$startStr&end_date=$endStr';
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception('Gagal mengambil data void items');
      }
    } catch (e) {

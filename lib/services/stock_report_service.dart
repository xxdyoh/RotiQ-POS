...
class StockReportService {
  ...
  static Future<Map<String, dynamic>> getStockReport({
    ...
    try {
      ...
      String url = '$baseUrl/report/stock?start_date=$startStr&end_date=$endStr';
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception('Gagal mengambil data laporan stock');
      }
    } catch (e) {
  ...
  static Future<List<String>> getCategories() async {
    try {
      final response = await http.get(
        Uri.parse('$baseUrl/report/stock-categories'),
        headers: await _getHeadersWithCabang(),
      );

...
class _ReturnFormScreenState extends State<ReturnFormScreen> {
  ...
  Future<void> _loadItems() async {
    ...
    try {
      ...
      setState(() {
        _allItems = items.map((item) => ReturnItem.fromJson(item)).toList();
      ...
      _showErrorSnackbar('Gagal memuat data items: ${e.toString()}');
    } finally {
      setState(() {
        _isLoading = false;
      });
  ...
  Future<void> _loadReturnDetail() async {
    ...
    try {
      ...
      setState(() {
        _selectedItems = _allItems.map((item) {
          ...
          return ReturnItem(
            ...
            qty: detailItem.isNotEmpty ? (detailItem['retd_qty'] ?? 0) : 0,
          );
        }).toList();
      ...
      _showErrorSnackbar('Gagal memuat detail return production: ${e.toString()}');
    } finally {
      setState(() {
        _isLoading = false;
      });
          ...
          children: [
                            ...
                            Container(
                              ...
                              child: TextField(
                                ...
                                decoration: InputDecoration(
                                  hintText: 'RETUR, RETUR PRODUCTION, dll.',
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: Text(
                  isEdit ? 'UPDATE RETURN' : 'SIMPAN RETURN',
                  style: GoogleFonts.montserrat(
                    fontSize: 12,
                    fontWeight: FontWeight.w600,
                  ),

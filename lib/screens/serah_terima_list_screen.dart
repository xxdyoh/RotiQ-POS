...
class _SerahTerimaListScreenState extends State<SerahTerimaListScreen> {
  ...
  int _totalFilteredSerahTerima = 0;
  ...
  Future<void> _loadSerahTerimaData() async {
    ...
    try {
      ...
      setState(() {
        ...
        _totalFilteredSerahTerima = data.length;
        _dataSource = SerahTerimaDataSource(
          serahTerimaList: data,
      ...
      _showSnackbar('Gagal memuat data serah terima', isError: true);
    } finally {
  ...
  void _onFilterChanged(DataGridFilterChangeDetails details) {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (_dataSource.effectiveRows != null) {
        setState(() => _totalFilteredSerahTerima = _dataSource.effectiveRows!.length);
      }
    });
  }
  ...
  void _deleteSerahTerima(Map<String, dynamic> serahTerima) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: Text('Hapus Serah Terima', style: GoogleFonts.montserrat(fontSize: 15, fontWeight: FontWeight.w600)),
        content: Text('Hapus "${serahTerima['stbj_nomor']}"?', style: GoogleFonts.montserrat(fontSize: 13, color: _textSecondary)),
        actions: [
          TextButton(
  ...
  void _showItemDetailDialog(Map<String, dynamic> serahTerima) {
    showDialog(
      context: context,
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child: Icon(Icons.inventory_rounded, size: 18, color: Colors.white),
                    ),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text('Detail Serah Terima', style: GoogleFonts.montserrat(fontSize: 14, fontWeight: FontWeight.w600, color: Colors.white)),
                          const SizedBox(height: 2),
                          Text(serahTerima['stbj_nomor'] ?? '-', style: GoogleFonts.montserrat(fontSize: 11, color: Colors.white.withOpacity(0.8))),
                        ],
                      ),
                    ),
                    IconButton(
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(DateFormat('dd MMMM yyyy').format(DateTime.parse(serahTerima['stbj_tanggal'])),
                      ...
                      child: Row(
                        children: [
                          Container(
                            ...
                            child: Icon(Icons.assignment_rounded, size: 14, color: _accentBlue),
                          ),
                          const SizedBox(width: 8),
                          Expanded(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text('No. SPK', style: GoogleFonts.montserrat(fontSize: 9, color: _textTertiary)),
                                Text(serahTerima['stbj_spk_nomor'] ?? '-',
                                    style: GoogleFonts.montserrat(fontSize: 11, fontWeight: FontWeight.w600, color: _textPrimary)),
                              ],
                            ),
                          ),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(serahTerima['stbj_keterangan'] ?? '-',
                              style: GoogleFonts.montserrat(fontSize: 11, fontWeight: FontWeight.w600, color: _textPrimary)),
                        ],
                      ),
                    ),
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: ClipRRect(
                                ...
                                child: SfDataGrid(
                                  source: SerahTerimaDetailDataSource(details: details),
              ...
              child: Row(
                children: [
                  ...
                  _buildActionButton(
                    ...
                    label: 'Load',
                    color: _accentMint,
                    onPressed: _loadSerahTerimaData,
                    isMobile: isMobile,
                  ),
                  const SizedBox(width: 8),
                  // Tambah Button
                        ...
                        child: ClipRRect(
                          ...
                          child: SfDataGrid(
                            ...
                            columns: [
                              ...
                              _buildGridColumn('spk_nomor', 'No. SPK', width: _columnWidths['spk_nomor']),
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Text('$_totalFilteredSerahTerima Transaksi', style: GoogleFonts.montserrat(fontSize: 10, color: _textSecondary)),
                              ],
                            ),
                            const Spacer(),
                            Text(
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Icon(Icons.inventory_rounded, size: 28, color: _textTertiary),
          ),
          const SizedBox(height: 16),
          Text('Belum ada data serah terima', style: GoogleFonts.montserrat(fontSize: 15, fontWeight: FontWeight.w500, color: _textPrimary)),
...
class SerahTerimaDataSource extends DataGridSource {
  SerahTerimaDataSource({
    ...
    _updateDataSource(serahTerimaList);
  }
  ...
  void _updateDataSource(List<Map<String, dynamic>> serahTerimaList) {
        ...
        if (cell.columnName == 'aksi') {
          ...
          return Container(
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                _buildIconButton(Icons.edit_outlined, () => _onEdit(data)),
                const SizedBox(width: 4),
                _buildIconButton(Icons.delete_outlined, () => _onDelete(data), color: _accentRed),
              ],
            ),
          );
        }
...
class SerahTerimaDetailDataSource extends DataGridSource {
  SerahTerimaDetailDataSource({required List<Map<String, dynamic>> details}) {
    _data = details.asMap().entries.map((entry) {
      ...
      return DataGridRow(cells: [
        ...
        DataGridCell<int>(columnName: 'qty', value: item['stbjd_qty'] ?? 0),
        DataGridCell<String>(columnName: 'keterangan', value: item['stbjd_keterangan']?.toString() ?? '-'),
      ]);
    }).toList();
  }
        ...
        if (cell.columnName == 'qty') {
          return Container(
            ...
            child: Container(
              ...
              child: Text(cell.value.toString(), style: GoogleFonts.montserrat(fontSize: 10, fontWeight: FontWeight.w600, color: _accentMint)),
            ),
          );
        }
        return Container(

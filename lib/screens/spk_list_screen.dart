...
class _SpkListScreenState extends State<SpkListScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _loadSpkData() async {
    ...
    try {
      ...
      _showToast('Gagal memuat data SPK: ${e.toString()}', type: ToastType.error);
    } finally {
      setState(() => _isLoading = false);
    }
  }

  void _calculateTotals(List<Map<String, dynamic>> spkList) {
    _totalFilteredSpk = spkList.length;
  }
  ...
  void _onFilterChanged(DataGridFilterChangeDetails details) {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (_dataSource.effectiveRows != null) {
        ...
        setState(() {
          _totalFilteredSpk = filteredData.length;
        });
      }
    });
  }
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  DateFormat('dd MMMM yyyy').format(DateTime.parse(spk['spk_tanggal'])),
                                  style: GoogleFonts.montserrat(
                                    fontSize: 11,
                                    fontWeight: FontWeight.w600,
                                    color: _textDark,
                      ...
                      child: Row(
                        children: [
                          Container(
                            ...
                            height: 32,
                            decoration: BoxDecoration(
                              color: spk['spk_isclosed'] == 1 ? _accentMintSoft : _accentGoldSoft,
                              borderRadius: BorderRadius.circular(8),
                            ),
                            child: Icon(
    ...
    try {
      ...
      for (var row in visibleRows) {
        ...
        for (var cell in cells) {
          ...
          } else if (cell.columnName == 'user_create') {
        ...
        sheet.getRangeByName('F$rowIndex').setText(user);
      ...
      sheet.getRangeByName('B$totalRow').setText('$_totalFilteredSpk SPK');
      ...
      if (kIsWeb) {
        ...
        final anchor = html.AnchorElement(href: url)
          ..target = 'blank'
          ..download = 'SPK_List_${DateFormat('yyyyMMdd_HHmmss').format(DateTime.now())}.xlsx'
          ..click();
        ...
        final file = File('${directory.path}/SPK_List_${DateFormat('yyyyMMdd_HHmmss').format(DateTime.now())}.xlsx');
                            ...
                            child: SfDataGrid(
                              ...
                              columns: [
                                ...
                                GridColumn(
                                  ...
                                  width: _columnWidths['keterangan'] ?? 300,
                                  minimumWidth: 250,
                                  maximumWidth: 900,
                                  label: Container(
                                    padding: const EdgeInsets.symmetric(horizontal: 6),
                                ...
                                GridColumn(
                                  ...
                                  width: _columnWidths['user_create'] ?? 120,
                                  minimumWidth: 100,
                                  maximumWidth: 150,
                                  label: Container(
                                    padding: const EdgeInsets.symmetric(horizontal: 6),
                            ...
                            child: SizedBox(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Container(
                                    width: (_columnWidths['keterangan'] ?? 300) + (_columnWidths['status'] ?? 90) + (_columnWidths['user_create'] ?? 120),
                                    padding: const EdgeInsets.symmetric(horizontal: 6),
                                    alignment: Alignment.centerLeft,
                                  ...
                                  Container(
                                    ...
                                    padding: const EdgeInsets.symmetric(horizontal: 4),
                                    alignment: Alignment.center,
                                    child: _totalFilteredSpk < _spkList.length
                                        ? Container(
                                      ...
                                      child: Text(
                                        '${_spkList.length - _totalFilteredSpk} filter',
                                        style: GoogleFonts.montserrat(
                                          fontSize: 8,
                                          fontWeight: FontWeight.w600,
                                          color: _accentGold,
        ...
        if (cell.columnName == 'sisa') {
          ...
          return Container(
            ...
            child: Container(
              padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 3),
              decoration: BoxDecoration(
                color: sisa > 0 ? _accentGold.withOpacity(0.1) : _accentMintSoft,
                borderRadius: BorderRadius.circular(6),
                border: Border.all(
                  color: sisa > 0 ? _accentGold.withOpacity(0.3) : _accentMint.withOpacity(0.3),
                ),
              ),
              child: Text(
                sisa.toString(),
                style: GoogleFonts.montserrat(
                  fontSize: 11,
                  fontWeight: FontWeight.w700,
                  color: sisa > 0 ? _accentGold : _accentMint,
                ),
              ),
            ),
          );
